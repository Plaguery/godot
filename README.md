...
I implemented the powerup and respawns using gdscript on the hitbox nodes. I ran into a bug where my powerup didn't work, but it turned out that I forgot to connect a signal to the powerup node.
